...
public class TextbookReservation {
     ...
     */
    TextbookReservation(boolean pS)
    {
        this.bookList = new ArrayList<BookItem>();
        this.paidStatus = pS;
        this.reservationDate = new Date();
     ...
     */
    TextbookReservation(boolean pS,Date rD)
    {
        this.reservationDate = rD == null ? new Date() : rD;
        this.bookList = new ArrayList<BookItem>();
        this.paidStatus = pS;
    }
    ...
    {
        this.reservationDate = rD == null ? new Date() : rD;
        this.bookList = b == null ? new ArrayList<BookItem>() : new ArrayList<BookItem>(b);
        this.paidStatus = pS;
    }
    ...
    public void setBookList(ArrayList<BookItem> bookList) {
        this.bookList = bookList == null ? new ArrayList<BookItem>() :
                new ArrayList<BookItem>(bookList);
    }
    ...
    /**
     * Method to add book items to a reservation
     * @param b book item
     */
    public void add_book(BookItem b){
        if (b != null) {
            bookList.add(b);
        }
    }
